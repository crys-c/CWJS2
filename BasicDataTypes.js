...
//variables a,b, please set the appropriate value for the two variables(select from v1--v6), making these function return value equal to 100. 
...
function equal5(){
  let a =  , //set number value to a
      b =  ; //set number value to b
  return a % b;
  // this is remainder it shows the remaining number after
  // the second number can go into the first number the max # of times
}